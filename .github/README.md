...
너무 React에 집중하다보니, 자바스크립트 자체를 잊어버리는 것 같아서 해당 기능을 개발하며 자바스크립트를 다시 공부하고자 했습니다. 또한, 이력서를 PDF로 변환하는 기능을 개발하면서, 이력서를 작성하는데 있어서 어떤 부분이 불편한지, 어떤 부분을 개선하면 좋을지에 대해 생각해보고자 했습니다.
...
직접 설정한 webpack 설정 파일을 통해 번들링을 해보면서 webpack의 핵심 기능에 대해 이해할 수 있었습니다.

### AWS EC2 배포

NodeJS 서버를 AWS EC2에 배포하면서, 서버를 운영하는데 필요한 기본적인 지식을 습득할 수 있었습니다.
